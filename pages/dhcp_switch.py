...
页面契约见 gui.py 顶部注释。交换机DHCP使用Vlanif接口。
"""
import ipaddress
import tkinter as tk
from tkinter import ttk

from modules import dhcp_switch
from widgets import RowsEditor


class DhcpSwitchPage:
    TITLE = "DHCP"
    ...
    def __init__(self, parent, app=None):
        ...
        self._rows = {}
        self.v_if = self._field("if_vlan", "VLAN ID", kind="vlan")
    ...
    def _sync_fields(self):
        ...
        if self.mode.get() == "relay":
            ...
            keys = ["if_vlan", "gw", "net", "mask", "dns", "lease"]
        for key in keys:
    ...
    def render(self, params):
        return dhcp_switch.generate(params)
